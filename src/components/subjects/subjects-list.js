...
import SubjectListItem from "./subjects-list-item";
...
const SubjectsList = () =>{
    ...
    const columns = [
        ...
        { title: "Subject Name", field: "name", resizeable:true, filterable: true  },
        { title: "Classfication", field: "classfication", resizeable:true, filterable: true },
        { title: "Subject Level", field: "level", resizeable:true },
        { title: "Creation Date", field: "dateCreated", resizeable:true},
